...
@JsonInclude(JsonInclude.Include.NON_NULL) //it excludes null values from the JSON response and includes only non-null fields in the serialized JSON output.
